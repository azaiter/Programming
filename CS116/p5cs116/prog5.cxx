...
int main()
{
	...
	outFile << "Name" << setw(20) << "Stud Id" << setw(10) << "Exam 1" <<  setw(10) << "Exam 2"
			<<  setw(10) << "Exam 3" <<  setw(10) << "AVG" <<  setw(20) << "Passed/Failed" << endl;
	outFile << "----" << setw(20) << "-------" << setw(10) << "------" << setw(10) << "------"  << setw(10)
 		...
 		(exam3 >= EXAM_MIN && exam3 <= EXAM_MAX) && (studId >= ID_MIN && studId <= ID_MAX))
    {
		...
		//I think that if >= 70 and nest it with if >= 97 is better way to do that
		if (examAvg >= 97.00)
		...
		outFile << left << setw(17) <<  studName << setw(11) << studId << setw(10) << exam1 << setw(10) << exam2
				<< setw(13) << exam3  << setw(10) << examAvg  << passingString << endl << endl;

	}
	else
		outFile << left << setw(17) << studName << setw(11) << studId << setw(10) << exam1 << setw(10) << exam2 <<
		setw(13) << exam3 << setw(10)  << "~~ Invalid data~~" << endl << endl;
